...
export default class WebotsView extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.toolbarCss.href = '/static/wwi/css/toolbar.css';
    ...
    this.progressCss.href = '/static/wwi/css/progress.css';
  ...
  #init() {
    ...
    promises.push(this.#loadScript('/static/wwi/dependencies/ansi_up.js'));
    promises.push(this.#loadScript('/static/wwi/dependencies/assimpjs.js'));
    promises.push(this.#loadScript('/static/wwi/dependencies/glm-js.min.js'));
    promises.push(this.#loadScript('/static/wwi/dependencies/quaternion.min.js'));
    promises.push(this.#loadScript('/static/wwi/dependencies/libtess.min.js'));
    promises.push(this.#loadScript('/static/wwi/enum.js'));
    promises.push(this.#loadScript('/static/wwi/wrenjs.js'));
  }
